...
def plotData():
   ...
   plt.ylabel('teta')
   plt.subplot(313)
   plt.plot(dataArray[5], dataArray[7], 'ro--')
   plt.grid(True)
   plt.xlabel('x')
   plt.ylabel('i_part')
      ...
      if msvcrt.kbhit():
         ...
         if (char == b'\r'):
            ...
            if (stringaArrivata == "quit"):
               print("go to quit")
               runState = False
            elif (stringaArrivata == "print"):
               printData = True
            elif (stringaArrivata == "help"):
               print("quit to exit")
               print("print to plot data")
               print("help to get this")
               print("....")
...
#   ser = serial.Serial('COM59', 38400, timeout=5, parity=serial.PARITY_NONE)
#   ser = serial.Serial('COM11', 9600, timeout=5, parity=serial.PARITY_NONE)
   ...
   while runState:
      if  ((runningOld == True) and (running == False)) or printData:
         plotData()
         printData = False
         #print('dato aggiunto')
